...
locPredictionMTLocB_8plot = MTLocB_8plot.predict([IMUTest,MagTest,WifiTest], batch_size=batch_size)
...
locPredictionMMTLocB_7plot = MTLocB_7plot.predict([IMUTest,MagTest,WifiTest], batch_size=batch_size)
...
locPredictionMTLocB_6plot = MTLocB_6plot.predict([IMUTest,MagTest,WifiTest], batch_size=batch_size)
...
plt.ylabel("CDF")
plt.grid(True)
plt.title(('Fine Tuning CDF (All)'))
plt.legend(loc='lower right')
fig.savefig("Fine-tuning_CDF(all).pdf")
print('cdf plotted')
